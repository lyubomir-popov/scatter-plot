...
function render(data, histoData, yDomain) {
  ...
  graph.append("g").attr("class", "histo")
    ...
    .enter().append("rect")
      ...
      .attr("height", function(d) { return height - yHisto(d); });
  ...
  dots = graph.append("g")
      ...
      .style("fill", function(d) { return  d.page === "Average" ? "#fff" : colorScale(d.page); })
